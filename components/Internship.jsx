	...
	return (
		<Section name='Internship'>
			<div className="mx-auto my-1 w-full flex flex-col justify-around place-items-center">
				...
				<button type="button" onClick={addInternship} className='m-1 px-3 py-2 rounded-xl select-none transition-all duration-500 border text-black bg-white lg:hover:text-white lg:hover:bg-purple-900'>Add Internship</button>
			</div>
		</Section>
	)
}
