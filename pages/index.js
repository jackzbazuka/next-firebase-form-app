...
export default function Signin() {
	...
	const [guidelines, setGuidlines] = useState([
		...
		"They are capped at 8 inputs in total and description fields are capped at 5 fields for each entry",
		"Space out your description into 2-3 lines, and keep it as minimal as possible for each line, try to avoid long paragraphs.",
		"In the description field, do not write more than 100 words (in total) for each Internship/ Project",
